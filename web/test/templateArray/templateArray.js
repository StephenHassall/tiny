...
import TemplateArray from "./../../tiny/templateArray.js";
import SpecialTemplateArray from "./specialTemplateArray.js";
...
export default class TemplateArrayController extends Controller {
    ...
    constructor() {
        ...
        super({
            htmlPath: 'templateArray.html',
            cssPath: 'templateArray.css',
